...
import telepot
bot = telepot.Bot('7746105135:AAGJkZK7DUvSV8TqKmZGbWzpOYjUsApaoa4')
                        ...
                        if names[c] in LABELS:
                            ...
                            if names[c] == 'Two-wheeler':
                                ...
                                if head_count != helmet_count:
                                    ...
                                    bot.sendMessage('1381326231',str("No helmet detected {}".format(number)))
                                    bot.sendPhoto('1381326231', photo = open('frame.png', 'rb'))
                                ...
                                if head_count > 2:
                                    ...
                                    cv2.imwrite('frame.png', im0)
                                    bot.sendMessage('1381326231',str("triple riding detected {}".format(number)))
                                    bot.sendPhoto('1381326231', photo = open('frame.png', 'rb'))
